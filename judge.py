...
# Paths and Config
INPUT_PATH = "simulation_output/contrarian_results_multiturn_openai_gpt-5.2.json"
OUTPUT_PATH = "judge_output/contrarian_judge_results_multiturn_" + config.JUDGE_MODEL + ('.json' if not TESTING else '_testing.json')
